...
import { useFetchGetAllarea } from "../query";
import { ItemareaColumna } from "./areaHeader";
import { ListCriterioarea } from "./criterio";
import { TableBodyFrmarea } from "./tableBody";

import { PrivateRoutes } from "@/routes/routes";
import { IconButton, Tooltip } from "@mui/material";
import { useNavigate } from "react-router-dom";
import { FrmActualizararea } from "../actualizar/FrmActualizarArea";
import { FrmCreararea } from "../crear/FrmCrearArea";

export const FrmListararea: React.FC<{}> = () => {
  ...
  return (
    <FormProvider {...methods}>
      ...
      <FrmCreararea state={stateCrear} setStateCrear={setStateCrear} />
      <FrmActualizararea state={stateUpdate} changeState={setStateUpdate} />
    </FormProvider>
  );
};
