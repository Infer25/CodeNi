...
import { ModelFrontedarea, ModelFrmareaFormulario } from "@/shared/zustand/slice/frmCatArea";
...
export type ModelTable = {
  ...
  List: ModelFrontedarea[];
};
export const TableBodyFrmarea: React.FC<ModelTable> = ({
  setStateUpdate,
  List,
}) => {
