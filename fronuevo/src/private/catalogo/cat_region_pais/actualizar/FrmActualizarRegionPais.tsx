...
export const FrmActualizarRegionPais: React.FC<{}> = () => {
  ...
  const onSubmit = (data: ModelFrmActualizarRegionPais) => {
    if (data.nombre != "" && data.descripcion != "" && data.id != 0) {
      actualizar(data);
      reset();
      navigate(`/${PrivateRoutes.PRIVATE}/${PrivateRoutes.SISTEMA}/${PrivateRoutes.CATREGIONPAIS}`);
    } else {
      alert("no valido");
    }
  };
  ...
  return (
    <FormContainer>
      <ToolBarTitle
        ...
        subMenu="Actualizacion region pais"
        children={
          ...
          <Controller
            ...
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                helperText={errors.nombre ? "Por favor agregar una región" : ""}
                type="search"
                autoComplete="off"
              />
            )}
          ...
          <Controller
            ...
            render={({ field: { onChange, value } }) => (
              <TextField
                ...
                helperText={
                  errors.descripcion
                    ? "Por favor agregar una descripcion de región"
                    : ""
                }
                type="search"
                autoComplete="off"
