...
export type ModelTableRowFrmRegionPais ={
    id: string;
    Nombre: string;
    Descripciòn: string;
    ["Registrado"]: string;
    ...
    export type ModelTableRowListFrmRegionPais ={
     List:ModelTableRowFrmRegionPais[]
    }
export const TableBodyFrmRegionPais: React.FC<ModelTableRowListFrmRegionPais> = ({
  List,
}) => {
  ...
  const setValueUpdate = useStoreGlobal((state) => state.setValueFrmRegionPais);
