...
import { FrmActualizarcolaborador } from "../actualizar/FrmActualizarcolaborador";
import { FrmCrearTipocolaborador } from "../crear/FrmCrearTipoColaborador";
import { useFetchGetAllTipocolaborador } from "../query";
import { ItemTipocolaboradorColumna } from "./colorHeader";
import { ListCriterioTipocolaborador } from "./criterio";
import { TableBodyFrmTipocolaborador } from "./tableBody";

export const FrmListarTipocolaborador: React.FC<{}> = () => {
    ...
    switch ((event.target as HTMLInputElement).value) {
      case "nombre": {
        setPlaceholder({
          ...
          placeHolder: "Filtrar por tipo de colaborador",
        });
        break;
      }
  ...
  const methods = useForm<ModelFrmTipocolaboradorFormulario>();

  const { data } = useFetchGetAllTipocolaborador(
    valueRadio,
    valorFiltro,
    pagina,
    comboValue.value
    ...
    <FormProvider {...methods}>
      <FormContainer>
        <ToolBarTitle
          ...
          subMenu="Lista de tipo de colaborador"
        ...
        <BuscadorBoton
          ...
          criterioFiltro={
            <RadioGrupCriterio
              ...
              itemList={ListCriterioTipocolaborador}
            />
          }
        ...
        <TableCustom
          list={ItemTipocolaboradorColumna}
          children={
            <TableBodyFrmTipocolaborador
      ...
      <FrmCrearTipocolaborador
        state={stateCrear}
        setStateCrear={setStateCrear}
      />
      <FrmActualizarcolaborador
        state={stateUpdate}
