...
export const FrmActualizarTipoIdentificacion: React.FC<{}> = () => {
  ...
  const onSubmit = (data: ModelFrmTipoIdentificacionFormulario) => {
    if (
      ...
      reset();
      navigate(
        `/${PrivateRoutes.PRIVATE}/${PrivateRoutes.SISTEMA}/${PrivateRoutes.CATTIPOIDENTIFICACION}`
      );
    } else {
      alert("no valido");
    }
  ...
  return (
    <FormContainer>
      <ToolBarTitle
        ...
        children={
          <CerrarBtn
            ruta={`/${PrivateRoutes.PRIVATE}/${PrivateRoutes.SISTEMA}/${PrivateRoutes.CATTIPOIDENTIFICACION}`}
          />
        }
      />
      <Box
