  ...
  return (
    <FormContainer>
      <ToolBarTitle
        ...
        subMenu="Lista de catalogo estado"
        children={
          <Tooltip title={"Cerrar"}>
            <IconButton
              onClick={() =>
                navigate(`/${PrivateRoutes.PRIVATE}/${PrivateRoutes.SISTEMA}/${PrivateRoutes.CATALOGOS}`, {
                  replace: true,
                })
              }
              size="large"
      ...
      <TableCustom
        ...
        children={<TableBodyFrmEstado List={data?.rows ? data?.rows : []} />}
      />
