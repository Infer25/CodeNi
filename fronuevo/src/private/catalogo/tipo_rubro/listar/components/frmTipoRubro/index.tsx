  ...
  return (
    <FormContainer>
      <ToolBarTitle
        ...
        subMenu="Lista de tipo de rubro"
        children={
          <CerrarBtn
            ruta={`/${PrivateRoutes.PRIVATE}/${PrivateRoutes.SISTEMA}/${PrivateRoutes.CATALOGOS}/`}
          />
        }
      />
      ...
      <TableCustom
        ...
        children={<TableBodyFrmTipoRubro List={data?.rows ? data?.rows : []} />}
      />
