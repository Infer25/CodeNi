...
import { useFetchGetAllDptoRegion } from "../../../query";
import { ItemDptoRegionColumna } from "../../columnItem";
import { rutaFrmDptoRegion } from "../../ruta";
import { ListCriterioDptoRegion } from "../criterio/criterio";
import { TableBodyFrmDptoRegion } from "../tableBodyFrmDptoRegion";


export const FrmDptoRegion: React.FC<{}> = () => {
  ...
  const handleChangeCriterio = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    switch ((event.target as HTMLInputElement).value) {
      ...
      case "region": {
        setPlaceholder({ label: "Region", placeHolder: "Filtrar por region" });
        break;
      }
      case "descripcion": {
        setPlaceholder({
  ...
  const { data } = useFetchGetAllDptoRegion(
    valueRadio,
    valorFiltro,
    pagina,
    comboValue.value
  ...
  return (
    <FormContainer>
      <ToolBarTitle
        ...
        subMenu="Catalogo Region pais"
        url={rutaFrmDptoRegion}
      />
      ...
      <BuscadorBoton
        ...
        criterioFiltro={
          <RadioGrupCriterio
            ...
            itemList={ListCriterioDptoRegion}
          />
        }
      ...
      <TableCustom
        list={ItemDptoRegionColumna}
        children={
          <TableBodyFrmDptoRegion List={data?.rows ? data?.rows : []} />
        }
      />
