...
import { ItemTipoTierraColumna } from "./colorHeader";
import { ListCriterioTipoTierra } from "./criterio";
import { rutaFrmCatTipoTierra } from "./ruta";
import { TableBodyFrmTipoTierra } from "./tableBody";
import { useFetchGetAllTipoTierra } from "../query";


export const FrmListarTipoTierra: React.FC<{}> = () => {
  ...
  const { data } = useFetchGetAllTipoTierra(
    valueRadio,
    valorFiltro,
    pagina,
    comboValue.value
  ...
  return (
    <FormContainer>
      ...
      <BuscadorBoton
        ...
        criterioFiltro={
          <RadioGrupCriterio
            ...
            itemList={ListCriterioTipoTierra}
          />
        }
      ...
      <TableCustom
        list={ItemTipoTierraColumna}
        children={<TableBodyFrmTipoTierra List={data?.rows ? data?.rows : []} />}
      />
